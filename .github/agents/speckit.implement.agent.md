...
2. **Check checklists status** (if FEATURE_DIR/checklists/ exists):
   ...
   - **Bash**: `.specify/scripts/bash/count-checklists.sh --feature-dir "$FEATURE_DIR"`
   - **PowerShell**: `pwsh -NoProfile -ExecutionPolicy Bypass -File .specify/scripts/powershell/count-checklists.ps1 -FeatureDir "$FEATURE_DIR"`
