...
4. Follow this execution flow:
    ...
    3. **Identify Semantic Scope**:
       ...
       - List modules that will be modified (in scope)
       - List modules that won't be touched (out of scope) to prevent ambiguity
       - Document any cross-module dependencies or impacts
       - If scope is unclear, make reasonable assumptions and document them
